...
| **Level 3 · trusted executor** | The hunks are produced or countersigned by a component outside the writing model's reach, the design the paper's §10.3 calls for once the writer itself may be an adversary. | No. The record format allows it; nothing produces it yet. |
